 ...
 * Static UI — data shown as empty state until consultations exist.
 */

import { MessageSquare, Calendar, User, Clock, CheckCircle, XCircle, Loader2 } from 'lucide-react';
...
// Static sample data — non-dynamic display
const SAMPLE = [
  { id: 1, patient: 'Rahul Sharma',    date: '2024-12-10', time: '10:00 AM', mode: 'Video',    status: 'COMPLETED', topic: 'Cardiology follow-up' },
  { id: 2, patient: 'Priya Mehta',     date: '2024-12-12', time: '02:30 PM', mode: 'In-person', status: 'COMPLETED', topic: 'Hypertension review' },
  { id: 3, patient: 'Arjun Nair',      date: '2024-12-15', time: '11:00 AM', mode: 'Video',    status: 'PENDING',   topic: 'Post-surgery check' },
  { id: 4, patient: 'Deepa Krishnan',  date: '2024-12-18', time: '09:00 AM', mode: 'Chat',     status: 'ACTIVE',    topic: 'Diabetes management' },
  { id: 5, patient: 'Suresh Babu',     date: '2024-12-20', time: '03:00 PM', mode: 'Video',    status: 'CANCELLED', topic: 'Routine checkup' },
];
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <StatCard icon={MessageSquare} label="Total"     value={SAMPLE.length} color="bg-indigo-50 text-indigo-600" />
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                {['Patient', 'Topic', 'Date & Time', 'Mode', 'Status'].map((h) => (
              ...
              {SAMPLE.map((c) => {
                ...
                return (
                  <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 text-gray-600">{c.topic}</td>
      ...
      <p className="text-xs text-gray-400 text-center">
        Showing sample consultation records. Live data loads when patients book appointments with you.
      </p>
    </div>
  );
};
